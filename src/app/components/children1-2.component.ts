...
import { Children121Component } from './children1-2-1.component';

@Component({
  selector: '[children1-2]',
  standalone: true,
  imports: [Children121Component],
  template: ` {{ triggerChangeDetection() }}
    <div class="node {{ componentName }}">
      ...
      <div class="children {{ componentName }}">
        ...
        <div children1-2-1 componentName="children1-2-1" nesting="4"></div>
      </div>
    </div>`,

  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class Children12Component extends DefaultComponent {}
